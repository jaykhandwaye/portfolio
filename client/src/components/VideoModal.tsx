        ...
        <DialogHeader className="relative">
          ...
          <div className="bg-black rounded-lg overflow-hidden aspect-video w-full mt-4">
            <div className="w-full h-96 flex items-center justify-center">
              {/* If video is a local file, show the video player */}
              {!video.isYoutubeVideo && !video.isPhotoGallery ? (
                <video 
                  src={video.videoUrl} 
                ...
                <>
                  {/* Show thumbnail as fallback for YouTube/gallery items (they should never reach here) */}
                  <img 
                    src={video.thumbnail} 
                    alt={video.title} 
