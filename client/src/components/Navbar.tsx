...
export default function Navbar() {
  ...
  const activeSection = useScrollSpy(
    ["home", "about", "portfolio", "services", "testimonials", "contact"],
    {
      threshold: 0.3,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <NavItem href="#portfolio" isActive={activeSection === "portfolio"}>
              Portfolio
            </NavItem>
            <NavItem href="#services" isActive={activeSection === "services"}>
              Services
            </NavItem>
            <NavItem
              href="#testimonials"
          ...
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent
                side="right"
                className="bg-white w-64 border-l border-gray-200"
              >
